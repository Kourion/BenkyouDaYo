...
\end{itemize}
%\begin{itemize}
\subsubsection{\ruby{宗教}{しゅうきょう} \tabni religion}
\begin{itemize}%\setlength\itemsep{-0.4em}
...
\end{itemize}
\subsubsection{\ruby{恩}{おん} \tabni Moral indebtedness}
\begin{itemize}%\setlength\itemsep{-0.4em}
\item auf die frage warum man was macht(私は恩があります。ですからそうです。) \\
\end{itemize}
\subsubsection{\ruby{義理}{ぎり} Moral and/or social obligation}
\begin{itemize}%\setlength\itemsep{-0.4em}
...
\item Also is concerned with matters of sport such as illegal betting on: Sakka, Baseball, Sumo.
\end{itemize}
...
\item The quality of the "senior"-high-school is very important for any japanese future career.
\end{itemize}
\end{enumerate}
