...
\begin{itemize}
\item \ruby{何時}{いつ} = when, \tabni --> \tabni \ruby{何時}{いつ}か = someday, \tabni --> \ruby{何時}{いつ}も = always/usually/every time |never (with neg. verb)

\item \ruby{何処}{どこ} = where, \tabni --> \tabni \ruby{何処}{どこ}か = somewhere, \tabni --> \tabni \ruby{何処}{どこ}も = everywhere/wherever |nowhere (with neg. verb)

\item \ruby{何}{なに} = what, \tabni --> \tabni \ruby{何}{なに}か = something, \tabni --> \tabni \ruby{何}{なに}も = all |nothing (with neg. verb)

\item \ruby{誰}{だれ} = who, \tabni --> \tabni \ruby{誰}{だれ}か = someone, \tabni --> \tabni  \ruby{誰}{だれ}も = everyone /anyone |no-one (with neg. verb)
\end{itemize}
